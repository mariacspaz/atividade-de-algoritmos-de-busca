...
eh_acíclico = nx.is_directed_acyclic_graph(grafo_dir)
print("É acíclico?", "Sim" if eh_acíclico else "Não")
...
def caminho_a_estrela(g, ini, alvo):
    ...
    while fila:
        ...
        for viz in g[atual]:
            ...
            if viz not in custos or novo_custo < custos[viz]:
